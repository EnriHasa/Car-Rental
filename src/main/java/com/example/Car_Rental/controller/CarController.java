...
public class CarController {
    ...
    @PutMapping("/{carId}")
    public ResponseEntity<CarDto> update(@Valid @RequestBody CarDto carDto, @PathVariable(name = "carId") Long carId) {
        return ResponseEntity.ok(carService.update(carDto, carId));
    }
